...
function Section1({hide}) {
  ...
  return (
    ...
    objectFit='contain' alt=""/>
            ...
            <div className="dig-0" id="digPos-0"></div>
            <div className="dialogue" id="dialogue-0">
                <p>
                Come join me on this journey as I show you my school
                </p>
            </div>
            ...
            {showLess?
              ...
              <p>
                I had been in an Akanksha school in Pune for 12 years until I graduated 10th grade this year. 
                I have secured admission at United World College
            ...
            {close => (
              ...
              <SimpleBarReact style={{ maxHeight: "70vh" }}>
                ...
                <div className='letter-content-container' style={{width:'100%',display:'flex',justifyContent:'space-between',flexWrap:'wrap'}}>
                  {
                    letterContent.map((obj) => {
                      return(
                        <div className='letter-content' key={obj.position} >
                        <p><span style={{fontWeight:'600',padding:'0rem 0',fontSize:'.9rem'}}>{obj.name}</span> <br/><span style={{fontSize:'.8rem'}}>{obj.position}</span><br/><span style={{fontSize:'.8rem'}}>{obj.title}</span></p>
                        </div>
                      )
                    })
                  }
